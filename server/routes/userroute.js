...
const { registration, login, checkuser, checkotp, updatepassword, editprofile, getUserById, logout, changepassword, getgarbage,getusertransaction, reedommoney,sendOtp,verifyUserByOtp } = require("../controller/usercontroller");
