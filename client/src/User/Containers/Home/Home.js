            ...
            <div className={classes.container}>
                ...
                <div className={classes.process}>
                    <div className={classes.title}>
                        <h3>Sell Your Scrap in 3 easy Steps</h3>
                    </div>
                    <div className={classes.cards}>
                        <div className={classes.card}>
                            <img src={scrap} className={classes.img} alt="scarp" />
                            <h5 className={classes.steps}>1.<br />Select Scrap item for selling</h5>
                        </div>
                        <div className={classes.card}>
                            <img src={calander} className={classes.img} alt="calander" />
                            <h5 className={classes.steps}>2.<br />Choose a date for Scrap pickup</h5>
                        </div>
                        <div className={classes.card}>
                ...
                <div className={classes.scrapdetails}>
                    <div className={classes.scrap}>
                        ...
                        <h4 style={{ fontWeight: "bold" }}>kg Scrap picked</h4>
                    </div>
                    <div className={classes.scrap}>
                        ...
                        <div className={classes.blocks}>
                            ...
                            <span>
                                ...
                                <small className={classes.small}>
                                    Scrapdeal collects 40+ scrap items that can be recycled like Paper, Plastic, Cartons, Metal, E-waste etc.
                                    </small>
                            </span>
                        </div>
                        <div className={classes.blocks}>
